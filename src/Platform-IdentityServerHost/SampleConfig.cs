...
namespace PSC.IdentityServerHost
{
        ...
        public static List<TestUser> GetUsers()
        {
            return new List<TestUser>
            {
                new TestUser
                {
                    ...
                    {
                        new Claim("name", "Enrico Rossini"),
                        new Claim("nickname", "Enrico"),
                        new Claim("website", "https://www.puresourcecode.com"),
                        new Claim("linkedin", "https://www.linkedin.com/in/rossiniuk/"),
                        new Claim("twitter", "https://www.twitter.com/erossiniuk"),
                    }
                }
            };
        }
